...
```bash
# From the repo root
gemini extensions install ./.gemini-extensions/roadmap
```
...
mkdir -p ~/.codex/plugins/roadmap
cp .codex-marketplace/roadmap/AGENTS.md ~/.codex/plugins/roadmap/AGENTS.md
ln -s "$(pwd)/plugins/roadmap/skills" ~/.codex/plugins/roadmap/skills
```

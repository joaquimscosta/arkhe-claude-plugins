...
model: opus
tools: Glob, Grep, Read, WebFetch, WebSearch, mcp__sequential-thinking__sequentialthinking
...
- If the problem is too vague, state the ambiguity and the interpretation you are analyzing under, then reason from that stated assumption — you run as a subagent and cannot prompt the user directly

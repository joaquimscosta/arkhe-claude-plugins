...
Some commands in `core` dispatch Claude subagents (a Claude-only capability). On Gemini and Codex, those commands ship with the agent's prompt **inlined** and a banner:

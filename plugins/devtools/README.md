...
```bash
# From the repo root
gemini extensions install ./.gemini-extensions/devtools
```
...
mkdir -p ~/.codex/plugins/devtools
cp .codex-marketplace/devtools/AGENTS.md ~/.codex/plugins/devtools/AGENTS.md
ln -s "$(pwd)/plugins/devtools/skills" ~/.codex/plugins/devtools/skills
```

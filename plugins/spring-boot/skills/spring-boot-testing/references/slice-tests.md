...
- [@WebMvcTest](#webmvctest)
  - [Java](#java)
  - [Kotlin](#kotlin)
  - [Classic MockMvc (still supported)](#classic-mockmvc-still-supported)
- [@DataJpaTest](#datajpatest)
  - [Java](#java-1)
  - [Kotlin](#kotlin-1)
  - [Using Real Database with Testcontainers](#using-real-database-with-testcontainers)
- [@JsonTest](#jsontest)
- [@RestClientTest](#restclienttest)
- [@WebFluxTest](#webfluxtest)
- [Custom Slice Annotation](#custom-slice-annotation)

...
```bash
# From the repo root
gemini extensions install ./.gemini-extensions/design-intent
```
...
mkdir -p ~/.codex/plugins/design-intent
cp .codex-marketplace/design-intent/AGENTS.md ~/.codex/plugins/design-intent/AGENTS.md
ln -s "$(pwd)/plugins/design-intent/skills" ~/.codex/plugins/design-intent/skills
```

...
1. [Stage 1: Context Gathering](#stage-1-context-gathering)
2. [Stage 2: Refinement & Structure](#stage-2-refinement--structure)
3. [Stage 3: Reader Testing](#stage-3-reader-testing)
4. [Streamlined Workflow](#streamlined-workflow)
5. [Code Documentation Patterns](#code-documentation-patterns)
...
1. What type of document is this? (e.g., technical spec, decision doc, proposal, README, API docs)
...
**Stage 1: Context Gathering (abbreviated)**
1. Ask about doc type and audience
2. Gather relevant code context
3. Identify existing documentation
4. Ask 3-5 clarifying questions

**Stage 2: Refinement & Structure**
1. Choose appropriate pattern from [Code Documentation Patterns](#code-documentation-patterns)
2. Create scaffold with sections
3. For each section:
...
**Process:**
1. Scan for REST endpoints (@app.route, router.get, etc.)
2. Extract parameters, types, descriptions
...
**Process:**
1. Identify services/modules
2. Map data stores and integrations
...
**Process:**
1. Scan config sources (.env, config files, CLI args)
2. Identify required vs optional
3. Document defaults and validation

...
```bash
# From the repo root
gemini extensions install ./.gemini-extensions/ralph
```
...
mkdir -p ~/.codex/plugins/ralph
cp .codex-marketplace/ralph/AGENTS.md ~/.codex/plugins/ralph/AGENTS.md
ln -s "$(pwd)/plugins/ralph/skills" ~/.codex/plugins/ralph/skills
```

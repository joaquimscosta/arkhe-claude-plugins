...
```bash
# From the repo root
gemini extensions install ./.gemini-extensions/google-stitch
```
...
mkdir -p ~/.codex/plugins/google-stitch
cp .codex-marketplace/google-stitch/AGENTS.md ~/.codex/plugins/google-stitch/AGENTS.md
ln -s "$(pwd)/plugins/google-stitch/skills" ~/.codex/plugins/google-stitch/skills
```

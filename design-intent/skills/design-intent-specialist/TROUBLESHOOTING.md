...
3. **If missing, recreate from code**
   ...
   - Run `/document-design-intent`

### Prevention

- Always run `/diary` at end of session
- Run `/document-design-intent` after successful implementations
...
4. Consider running `/document-design-intent` to capture what's working
